...
* Install the following packages: `celery <http://pypi.python.org/pypi/celery>`_, `django-celery <http://pypi.python.org/pypi/django-celery>`_,  `kombu <http://pypi.python.org/pypi/kombu>`_
